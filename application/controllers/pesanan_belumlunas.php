...
class Pesanan_belumlunas extends CI_Controller {
 ...
 function index()
 {
   if($this->session->userdata('logged_in'))
   {
     ...
     $crud->unset_edit();
     $crud->unset_read();
     $crud->add_action('LIHAT', '', 'pesanan_belumlunas/view_pesananbelumlunas','ui-icon-search');
     $crud->add_action('JADIKAN LUNAS', '', 'pesanan_belumlunas/update_status_pesanan','ui-icon-circle-minus');
     ...
     $this->load->view('pesanan_belumlunas_view', $data);
 ...
 function view_pesananbelumlunas($id_nota){
     $session_data = $this->session->userdata('logged_in');
