...
class Pesanan_lunas extends CI_Controller {
 ...
 function index()
 {
   if($this->session->userdata('logged_in'))
   {
     ...
     $crud->unset_edit();
     $crud->unset_read();
     $crud->add_action('LIHAT', '', 'pesanan_lunas/view_pesananlunas','ui-icon-search');
     $crud->add_action('JADIKAN BELUM LUNAS', '', 'pesanan_lunas/update_status_pesanan','ui-icon-circle-minus');
     ...
     $this->load->view('pesanan_lunas_view', $data);
 ...
 function view_pesananlunas($id_nota){
     $session_data = $this->session->userdata('logged_in');
